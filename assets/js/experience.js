...
const exp = [
  {
    ...
    place: "Capegemini Technology Services",
    time: "(August, 2021 - present)",
    desp: "<li>Working as a part of the Financial services team.</li><li>Cerified in Microsoft azure cloud.</li>",
  },
  {
    title: "Machine Learning Intern",
    cardImage: "assets/images/experience-page/dcb.jpeg",
    place: "Department of Bioinformatics and Computational Biology,University of Kerala",
    time: "(May - July, 2019)",
  ...
  },
  {
    ...
    desp:"<li>Worked as an administrator for linkedin page of the magazine for thae Asia and south pacific regions</li>",
  },
];
